...
class NewsStory(object):
    ...
    def get_guid(self):
        ...
        return get_guid
    def get_title(self):
        get_title = self.title
        return get_title
    def get_description(self):
        get_description = self.description
        return get_description
    def get_link(self):
        get_link = self.link
        return get_link
    def get_pubdate(self):
        get_pubdate = self.pubdate
        return get_pubdate
...
class TimeTrigger(Trigger):
    def __init__(self,Testtime):
        Testtime = datetime.strptime(Testtime, "%d %b %Y %H:%M:%S")
        # Testtime.replace(tzinfo=None)
        # Testtime = Testtime.replace(tzinfo = pytz.timezone('EST'))
...
def filter_stories(stories, triggerlist):
    ...
    """
    # TODO: Problem 10
    t = OrTrigger(triggerlist[0],triggerlist[1])
    filteredstories = []
